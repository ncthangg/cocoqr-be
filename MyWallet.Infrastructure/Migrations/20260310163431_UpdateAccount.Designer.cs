...
namespace MyWallet.Infrastructure.Migrations
{
    ...
    [Migration("20260310163431_UpdateAccount")]
            ...
            modelBuilder.Entity("MyWallet.Domain.Entities.Account", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("UserId"), new[] { "AccountNumber", "AccountHolder", "BankCode", "BankName", "Provider", "Balance", "IsPinned", "IsActive" });
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("UserId", "IsActive"), new[] { "AccountNumber", "AccountHolder", "BankCode", "BankName", "Provider", "Balance", "IsPinned" });
