...
namespace MyWallet.Infrastructure.Migrations
{
    ...
    [Migration("20260311053904_UpdateAccountIndex1")]
    partial class UpdateAccountIndex1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MyWallet.Domain.Entities.Account", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("UserId", "IsActive"), new[] { "AccountNumber", "AccountHolder", "BankCode", "BankName", "Provider", "Balance", "IsPinned", "CreatedAt" });

                    b.HasIndex("UserId", "AccountNumber", "Provider")
                        .IsUnique()
                        .HasDatabaseName("IX_Accounts_UserId_AccountNumber_Provider");
