...
{
    [DbContext(typeof(CocoQRDbContext))]
    [Migration("20260713073358_AddCocoMailCallbackTracking")]
    partial class AddCocoMailCallbackTracking
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CocoQR.Domain.Entities.Account", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("CocoQR.Domain.Entities.BankInfo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CocoQR.Domain.Entities.CocoMailCallbackEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("CocoMailCallbackEvents", (string)null);
                });

            modelBuilder.Entity("CocoQR.Domain.Entities.ContactMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CocoQR.Domain.Entities.EmailConversation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CocoQR.Domain.Entities.EmailConversationMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("LastCallbackEventId")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<string>("LastCallbackPayload")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("EmailConversationMessages", (string)null);
                });
            ...
            modelBuilder.Entity("CocoQR.Domain.Entities.QRHistory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("CocoQR.Domain.Entities.QRStyle", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CocoQR.Domain.Entities.QRStyleLibrary", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CocoQR.Domain.Entities.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CocoQR.Domain.Entities.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CocoQR.Domain.Entities.UserRole", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CocoQR.Domain.Entities.UserToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CocoQR.Domain.Entities.Account", b =>
                {
                    b.HasOne("CocoQR.Domain.Entities.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("CocoQR.Domain.Entities.EmailConversationMessage", b =>
                {
                    b.HasOne("CocoQR.Domain.Entities.EmailConversation", "Conversation")
                        .WithMany()
            ...
            modelBuilder.Entity("CocoQR.Domain.Entities.QRHistory", b =>
                {
                    b.HasOne("CocoQR.Domain.Entities.Account", "Account")
            ...
            modelBuilder.Entity("CocoQR.Domain.Entities.QRStyle", b =>
                {
                    b.HasOne("CocoQR.Domain.Entities.QRHistory", "QR")
                        .WithMany()
                        .HasForeignKey("QrId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CocoQR.Domain.Entities.UserRole", b =>
                {
                    b.HasOne("CocoQR.Domain.Entities.Role", "Role")
                        .WithMany("UserRoles")
